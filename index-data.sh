...
PRODUCTS_JSON_FILE="$(pwd -P)/week2/conf/bbuy_products.json"
QUERIES_JSON_FILE="$(pwd -P)/week2/conf/bbuy_queries.json"
DATASETS_DIR="$(pwd -P)/datasets"
PYTHON_LOC="$(pwd -P)/week2"
